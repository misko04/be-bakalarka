...
public  class LambdaRequestHandler implements RequestHandler<RequestClass, Map<String, Object> >{   
    ...
    public Map<String, Object> handleRequest(RequestClass request, Context context){
        ...
        try{
        String spotId = getReservations(userId,date).getsId();
        ...
        item.put("reservationMade",  true);
        String body =  item.toString();
        res.put("body", body);

        }catch(Exception e){
            ObjectNode item = JsonNodeFactory.instance.objectNode();
            item.put("reservationMade",  false);
            res.put("body", item.toString());
        }
        return res;
    ...
    public Reservations getReservations(String userId, String date) {
    ...
    public ParkingSpot getSpotNum(String spotId) {
        DynamoDBScanExpression scanExpression = new DynamoDBScanExpression();
